      ...
      <div class="row g-4">
            ...
            <div class="service__items">
               <div class="service__thumb">
                  <a href="service-single.html">
                     <img src="assets/img/service/service1.jpg" alt="service__image" style="height: 60%;">
                  </a>
               </div>
         ...
         <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
            <div class="service__items">
               <div class="service__thumb">
                  <a href="service-single.html">
                     <img src="assets/img/service/service2.jpg" alt="service__image" style="height: 60%;" >
                  </a>
               </div>
               <div class="service__content">
                  <h4>
         ...
         <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
            <div class="service__items">
               <div class="service__thumb">
                  <a href="service-single.html">
                     <img src="assets/img/party/wedding3.jpg" alt="service__image" style="height: 60%;">
                  </a>
               </div>
               <div class="service__content">
                  <h4>
         ...
         <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
            <div class="service__items">
               <div class="service__thumb">
                  <a href="service-single.html">
                     <img src="assets/img/service/service3.jpg" alt="service__image" style="height: 60%;"> 
                  </a>
               </div>
               <div class="service__content">
                  <h4>
         ...
         <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
            <div class="service__items style__service">
               <div class="service__thumb">
                  <a href="service-single.html">
                     <img src="assets/img/service/service4.jpg" alt="service__image" style="height: 60%;">
                  </a>
               </div>
               <div class="service__content">
                  <h4>
         ...
         <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
            <div class="service__items style__two">
               <div class="service__thumb">
                  <a href="service-single.html">
                     <img src="assets/img/service/service5.jpg" alt="service__image" style="height: 60%;">
                  </a>
               </div>
               <div class="service__content">
                  <h4>
